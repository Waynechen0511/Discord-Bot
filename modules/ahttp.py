...
class AIOHTTP:
    def __init__(self, timeout=10):
        ...
        self.image_types = ["image/png", "image/jpg", "image/jpeg", "image/x-icon"]
    ...
    async def get_json(self, url: str, default=None) -> Union[dict, None]:
        try:
            async with self.session.get(url) as resp:
                try:
    ...
    async def get_text(self, url: str, default=None) -> Union[str, None]:
        try:
            async with self.session.get(url) as resp:
                try:
